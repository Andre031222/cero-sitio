...
/**
 * Lo que hace falta para que {@code curl -fsSL https://corvo.ginit.dev/instalar | sh} funcione.
 *
...
public class InstaladorController {
    ...
    private static final String PAQUETE = "corvo-" + VERSION + ".tar.gz";
